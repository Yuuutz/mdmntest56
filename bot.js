...
const adminprefix = "-v";
const devs = ['403579210062364672','350135013465128966'];
client.on('message', message => {
...
client.on('message', message => {
  ...
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/UGarbRd**")
...
client.on('message', msg => {
    if (msg.content === 'سلام عليكم') {
      msg.reply('**:rose:عليكم سلام:rose:**');
    }
  });
client.on('message', msg => {
    if (msg.content === '@MDMN😄') {
      msg.reply('**دقايق ويمك**');
    }
  });
client.on('message', msg => {
    if (msg.content === 'مرحباء') {
      msg.reply('**مراحب حب**');
    }
  });
client.on('message', msg => {
...
client.on('message', msg => {
    if (msg.content === 'شلونك') {
      msg.reply('**بخير بشوفتك**');
    }
  });
client.on('message', msg => {
    if (msg.content === 'راح اطلع') {
      msg.reply('**تنورنه بي وقت الله وياك**');
    }
  });
client.on('message', msg => {
    if (msg.content === 'سلام') {
...
client.on('message', function(message) {
    ...
    const embed500 = new Discord.RichEmbed()
      .setTitle(":x: | تمت معاقبتك")
            .addField(`** لقد قمت بمخالفة قوانين السيرفر من خلال نشر روابط اخرى  **` , `**ان كأن هاذه الميوت عن طريق الخطأ تواصل مع احد اعضاء الادارة**`)
      .addField(`Magic`,`Server`)
            .setColor("c91616")
            .setThumbnail(`${message.author.avatarURL}`)
            .setAuthor(message.author.username, message.author.avatarURL) 
...
client.on('message', function(message) {
    ...
    const embed500 = new Discord.RichEmbed()
      .setTitle(":x: | تمت معاقبتك")
            .addField(`** لقد قمت بمخالفة قوانين السيرفر من خلال نشر روابط يوتيوب اخرى  **` , `**ان كأن هاذه الميوت عن طريق الخطأ تواصل مع احد اعضاء الادارة**`)
      .addField(`Magic`,`Server`)
            .setColor("c91616")
            .setThumbnail(`${message.author.avatarURL}`)
            .setAuthor(message.author.username, message.author.avatarURL) 
...
client.login("NTkwMjk0OTM3NTg1NzEzMTUy.XRAbtQ.d875wyUA8QWp_yUdOkrjzfLYC1A")
